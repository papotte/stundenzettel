...
export default function TimesheetPreview({ selectedMonth, user, entries, t, locale, userSettings, getEntriesForDay, calculateWeekTotal, getLocationDisplayName, onEdit, onAdd }: TimesheetPreviewProps) {
  ...
  return (
    <div className="bg-white p-8 rounded-md shadow-md printable-area font-body print:p-2 print:shadow-none print:text-xs" data-testid="timesheet-preview">
      <div id="pdf-header-section">
        <TimesheetHeader userSettings={userSettings} t={t} />
        <header className="flex justify-between items-start mb-4 print:mb-2" data-testid="timesheet-title">
      ...
      <main id="pdf-main-section">
        {relevantWeeks.map((week, weekIndex) => (
          <div key={weekIndex} className="mb-6 print:mb-3" data-testid={`timesheet-week-${weekIndex}`}>
            ...
            <div className="flex w-1/2 mt-2 justify-self-end justify-between print:text-xs print:mt-1" data-testid={`timesheet-week-${weekIndex}-total`}>
        ...
        <div className="flex w-1/2 mt-8 justify-between justify-self-end print:text-xs print:mt-4" data-testid="timesheet-month-total">
