...
let userSettings: { [userId: string]: Partial<UserSettings> } = {
    'mock-user-1': { defaultWorkHours: 7, defaultStartTime: "09:00", defaultEndTime: "17:00", language: 'de' },
    'mock-user-2': { defaultWorkHours: 7.5, defaultStartTime: "08:30", defaultEndTime: "16:30", language: 'en' },
};
