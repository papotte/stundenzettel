...
console.error(
  '🔍 STRIPE DEBUG - STRIPE_SECRET_KEY exists:',
  !!process.env.STRIPE_SECRET_KEY,
)
console.error(
  '🔍 STRIPE DEBUG - STRIPE_SECRET_KEY length:',
  process.env.STRIPE_SECRET_KEY?.length || 0,
)
console.error(
  '🔍 STRIPE DEBUG - STRIPE_SECRET_KEY starts with sk_:',
  process.env.STRIPE_SECRET_KEY?.startsWith('sk_') || false,
)
console.error('🔍 STRIPE DEBUG - NODE_ENV:', process.env.NODE_ENV)
console.error(
  '🔍 STRIPE DEBUG - All env vars with STRIPE:',
