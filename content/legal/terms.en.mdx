...
- **Application** means the software program provided by the Company downloaded by You on any electronic device, named TimeWise
...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TimeWise.
...
- **Website** refers to TimeWise, accessible from [https://time.papotte.dev](https://time.papotte.dev)
